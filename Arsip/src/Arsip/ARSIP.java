...
public class ARSIP extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panel1.add(txt_deskripsi, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(11, 43, 0, 0);
        panel1.add(txt_lokasi, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(11, 43, 0, 0);
        panel1.add(cmb_kategori, gridBagConstraints);
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(panel1, javax.swing.GroupLayout.DEFAULT_SIZE, 882, Short.MAX_VALUE)
        );
    ...
    private void btn_tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tambahActionPerformed
        ...
        try {
            String sql = "INSERT INTO tb_dok VALUES ('"+txt_kode.getText()+"','"+txt_nama.getText()+
                    "','"+cmb_kategori.getSelectedItem()+"','"+txt_lokasi.getText()+"','"+txt_deskripsi.getText()+
                    "','"+txt_tanggal.getText()+"')";
            java.sql.Connection conn = (Connection)Koneksi.configDB();
        ...
        // TODO add your handling code here:
         try {
            String sql = "INSERT INTO tb_dok VALUES ('"+txt_kode.getText()+
                    "','"+txt_nama.getText()+"','"+cmb_kategori.getSelectedItem()+
                    "','"+txt_lokasi.getText()+"','"+txt_deskripsi.getText()+
                    "','"+txt_tanggal.getText()+"')";
            java.sql.Connection conn = (Connection)Koneksi.configDB();
            java.sql.PreparedStatement pstm = conn.prepareStatement(sql);
            pstm.execute();
    ...
    private void btn_ubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ubahActionPerformed
        ...
        try {
            String sql = "UPDATE tb_dok SET kode = '"+txt_kode.getText()+
                    ...
                    +cmb_kategori.getSelectedItem()+"',lokasi = '"
                    +txt_lokasi.getText()+"',deskripsi = '"+txt_deskripsi.getText()
